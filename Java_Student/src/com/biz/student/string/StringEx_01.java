 ...
 * 근본적인 형(Type) 은 클래스이다
 * 따라서 String형 변순느 일반변수라기 보다는 객체(인스턴스)이다
 * 
 * 일반변수(primitive)와 객체의 차이
 * 일반변수는 : 그냥 데이터를 저장하는 메모리의  저장 공간일 뿐이다.
 * 객체 : 데이터를 저장하는 용도 외에 다양한 method를 통하여
 * 		데이터를 가공, 연산 하는 일들을 수행 할 수 있다.
 */
public class StringEx_01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * strNation은 문자열 변수 이면서 String class를 사용하여 만든 
		 * String type 객체이다.
		 * 따라서 점(.) 연산자를 통하여 다양한 method를 사용 할 수 있다.
		 */
		
		// strNation에 담긴 문자열을 모두 대문자로 바꿔서 return하는 메서드
