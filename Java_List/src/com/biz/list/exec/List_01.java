...
public class List_01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Random 클래스를 사용해서 뭔가 수행을 하기 위한 준비 클래스
		 * Random 클래스의 인스턴스(Instance),객체(object)
		 * rnd인스턴스를 사용가능하도록 초기화
		 * new : rnd인스턴스를 초기화 하겠다 라는 키워드
		 * 생성자(Constructor) method
		 */
		Random rnd = new Random();
		//Random클래스를 사용해서 rnd인스턴스를 선언하고
		//Random()생성자를 호출하여 
		//rnd인스턴스를 초기화(새로만들기 new)하라
		...
		intList.add(90); //size() 1인 리스으가 되고 데이터 1개 추가
		intList.add(100); //리스트를 데이터 개수만큼 추가해서 사용
